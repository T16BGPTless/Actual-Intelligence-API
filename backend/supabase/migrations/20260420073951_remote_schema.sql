...
CREATE OR REPLACE FUNCTION "public"."create_chat_with_initial_request"("p_category" "text", "p_request_text" "text", "p_tokens_to_spend" bigint) RETURNS "jsonb"
...
ALTER FUNCTION "public"."create_chat_with_initial_request"("p_category" "text", "p_request_text" "text", "p_tokens_to_spend" bigint) OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."post_requester_message"("p_chat_id" "text", "p_message" "text", "p_tokens" bigint) RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
declare
...
ALTER FUNCTION "public"."post_requester_message"("p_chat_id" "text", "p_message" "text", "p_tokens" bigint) OWNER TO "postgres";
...
GRANT ALL ON FUNCTION "public"."create_chat_with_initial_request"("p_category" "text", "p_request_text" "text", "p_tokens_to_spend" bigint) TO "authenticated";



GRANT ALL ON FUNCTION "public"."post_requester_message"("p_chat_id" "text", "p_message" "text", "p_tokens" bigint) TO "authenticated";
