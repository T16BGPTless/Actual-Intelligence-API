      ...
      >
        ...
        <Box sx={{ mb: 4 }}>
          ...
          <Box sx={{ display: "flex", alignItems: "center", gap: 1, flexWrap: "wrap" }}>
            {TOKEN_PRESETS.map((t) => {
              ...
              return (
                <Box
                  ...
                  sx={{
                    height: 32, px: 2, borderRadius: "99px",
            ...
            <Box
              sx={{
                height: 32, px: 1, borderRadius: "99px",
            ...
            >
              <input
                ...
                style={{
                  ...
                  color: customActive ? theme.palette.background.default : theme.palette.text.secondary,
                }}
              />
            </Box>
          </Box>
        ...
        {/* Error */}
        {error && (
          <Alert severity="error" sx={{ mb: 3, borderRadius: "8px", border: `0.5px solid ${theme.palette.error.main}`, fontSize: "0.85rem" }}>
            {error}
          </Alert>
        )}
        ...
        <Box sx={{ display: "flex", justifyContent: "flex-end", gap: 1.5, alignItems: "center" }}>
          ...
          <Button
            ...
            sx={{
              ...
              "&:hover": { bgcolor: theme.palette.text.secondary, transform: animationsEnabled ? "translateY(-1px)" : "none" },
